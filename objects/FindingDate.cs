...
namespace FindDate.Objects
{
  public class FindingDate
  {
    ...
    {
      double monthInt = double.Parse(month);
      double dayInt = double.Parse(day);
      double yearInt = double.Parse(year);//1999
      ...
      double yearDiff = Math.Abs(yearInt - 2000);//yearDiff = 1999-2000 = 1
    ...
    else
    {
      ...
      double yearDiff = Math.Abs(yearInt - 2000);//yearDiff = 1999-2000 = 5
